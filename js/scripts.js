...
// EXECUTION CODE
	...
	// ----------------------------------------
	// JAVASCRIPT CART ENABLE  ------------------
	// ----------------------------------------
		// since this is a portfolio piece and this cart code isn't according to the original spec and not all that pretty I've disabled it
		// enableSlideOutShoppingCart();
		// disableSlideOutShoppingCart();
		// makeProductsDrag2();
	// ----------------------------------------
	// END JAVASCRIPT CART ENABLE  ------------------
	// ----------------------------------------
